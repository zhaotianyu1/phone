...
package com.example.tclphone.litepal.parser;

import android.text.TextUtils;


import com.example.tclphone.litepal.exceptions.InvalidAttributesException;
...
public final class LitePalAttr {
	...
	public List<String> getClassNames() {
		if (classNames == null) {
			...
			classNames.add("com.example.tclphone.litepal.model.Table_Schema");
