...
//
//
//        // Favor the "start" activity_audio_call_outgoing direction over the end when bringing one side or the other
//
//        // of a large rect into view. If we decide to bring in end because start is already
//
//        // visible, limit the scroll such that start won't go out of bounds.
        ...
        try {
            ...
            try {
                ...
                if (dx != 0 || dy != 0) {
                    ...
                    Log.i("MySmoothScrollBy", "dx="+dx + " dy="+dy);
