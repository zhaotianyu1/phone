...
/**
 * Zmf loopback audio start
 *
 * @param[in]  inputId           the inputId of Zmf inputCallback audio
 *
 * @return                       0 on succeed, otherwise failed.
 */
...
/**
 * set the volume of loopback audio
 *
 * @param[in]  micVolumeWeight   the Weight of Zmf inputCallback audio, vary from 0 to 1
 *
 * @return                       0 on succeed, otherwise failed.
 */
 ...
 * set the volume of loopback audio
 *
 * @return                       the Weight of Zmf inputCallback audio, vary from 0 to 1
 */
...
/** Font activity_audio_call_outgoing info */
typedef struct {
    unsigned        shadowRGBA;
 ...
 *
 * @param[in] str   string
 * @param[in] info  activity_audio_call_outgoing info
 * @return I420 buffer
 */
